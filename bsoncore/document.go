// Copyright (C) Simon Schmidt 2021
...
import (
	...
	"github.com/mad-day/bsonbox/bsontype"
)
...
// NewInsufficientBytesError creates a new InsufficientBytesError with the given Document and remaining
// bytes.
